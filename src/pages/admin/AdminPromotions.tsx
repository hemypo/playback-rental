...
export default function AdminPromotions() {
  const { promotions, isLoading, addPromotion, updatePromotion, deletePromotion, reorderPromotions } = usePromotionManagement();
    ...
    <div className="container mx-auto py-6">
      ...
      <div className="my-4 p-4 bg-muted/50 rounded-lg">
        ...
        <ul className="list-disc pl-5 space-y-1 text-sm">
          ...
          <li>Изображение будет отображаться с соотношением сторон 9:16</li>
