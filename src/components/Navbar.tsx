          ...
          <div className="flex items-center gap-3">
            <div className="hidden lg:flex items-center gap-4 mr-4">
              ...
              <a href="https://vk.com/playbackkem" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2" width="24" height="24">
                  <path d="M24 4C13.5 4 4.5 13 4.5 24s9 20 19.5 20 19.5-9 19.5-20S34.5 4 24 4z"/>
                  <path d="M33 30h-2.4c-.8 0-1.1-.6-2.8-2.4-1.4-1.4-2-1.2-2.3-1.2-.4 0-.5.1-.5.6v1.9c0 .5-.1.8-1.2.8-2.3 0-5-1.6-6.8-4.8C15 20 14.7 18 14.7 18s-.1-.6.4-.6h2.4c.5 0 .7.2.9.7.9 2 2.3 4.7 2.8 5 .5.4.8.4.8-.2v-1.9c-.2-1.2-1-1.3-1-1.8 0-.2.2-.5.6-.5h3.8c.5 0 .6.2.6.7v3c0 .3.1.5.5.5.3 0 .7-.2 1.4-1 2-2 3.4-5 3.4-5s.1-.2.3-.2h2.5c.4 0 .6.3.5.6-.2.6-2 4.1-4.4 6.2-.4.4-.6.6 0 1 .4.4 1.5 1.4 2.1 2.3.5.8 1.1 1.6 1.5 2.2.3.5.1.9-.5.9z"/>
                </svg>
              </a>
