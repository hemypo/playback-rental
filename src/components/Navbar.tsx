            ...
            <div className="hidden lg:flex items-center gap-4 mr-4">
              ...
              <a href="https://vk.com/playbackkem" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
                  <path d="M5.45 5c.277 0 .51.18.607.432.746 2.01 2.015 4.17 3.105 5.01.293.227.539.058.539-.27V5.64a.64.64 0 0 1 .64-.64h1.62c.353 0 .64.287.64.64v4.054c0 .357.43.501.666.263 1.017-1.007 1.789-2.56 2.073-3.262A.64.64 0 0 1 15.9 5h1.724c.466 0 .79.477.61.91-.84 2.006-2.12 4.35-3.553 5.763-.293.29-.3.773-.015 1.07 1.046 1.098 2.268 2.085 3.224 2.94.41.369.134 1.06-.422 1.06H15.8c-.27 0-.526-.107-.714-.298l-2.18-2.2c-.205-.207-.558-.06-.558.23v1.69c0 .353-.287.64-.64.64h-1.6a.64.64 0 0 1-.64-.64V5.64c0-.353.287-.64.64-.64h1.62z"/>
                </svg>
              </a>
            </div>
