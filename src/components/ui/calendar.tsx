    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 font-medium text-sm hover:bg-accent hover:text-accent-foreground transition-colors"
        ),
        day_selected:
        ...
        day_range_start: "day-range-start aria-selected:bg-primary aria-selected:text-primary-foreground rounded-l-md rounded-r-none",
        day_range_end: "day-range-end aria-selected:bg-primary aria-selected:text-primary-foreground rounded-r-md rounded-l-none",
